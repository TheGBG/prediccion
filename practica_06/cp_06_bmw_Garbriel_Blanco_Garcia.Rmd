...
```{r carga y limpieza}
bmw <- getSymbols("BMW.DE", from = "2014-01-01", auto.assign = FALSE)
wagen <- getSymbols("VOW.DE", from = "2014-01-01", auto.assign = FALSE)
...
del modelo de volatilidad. 

Se construye el GARCH(1, 1)
```{r GARCH BMW}
garch_bmw <- garchFit(~1 + garch(1, 1),
